 ...
 *
 * This file was automatically generated by Aegir 6.x-1.6
 * on Sun, 11 Dec 2011 23:26:03 -0800.
 *
 ...
 */
  ...
  */
  ...
  $conf['file_directory_path'] = 'sites/drudrops/files';
  $conf['file_directory_temp'] = 'sites/drudrops/files/tmp';
  $conf['clean_url'] = 1;
  $conf['aegir_api'] = 1;
...
# Extra configuration from modules:
  ...
  */
  ...
  if (file_exists('/var/aegir/hostmaster-6.x-1.6/sites/drudrops/local.settings.php')) {
    include_once('/var/aegir/hostmaster-6.x-1.6/sites/drudrops/local.settings.php');
  }
